...
public class AddToDoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TO-DO - Indicate result and finish
                setResult(RESULT_CANCELED);
                finish();
			}
		});

		// TO-DO - Set up OnClickListener for the Reset Button
		final Button resetButton = (Button) findViewById(R.id.resetButton);
		resetButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {

				// TO-DO - Reset data to default values
                setDefaultDateTime();
			}
		});
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TO-DO - Get the current Priority
				Priority priority = getPriority();
				// TO-DO - Get the current Status
				Status status = getStatus();
				// TO-DO - Get the current ToDoItem Title
